...
import { Sparkles, Cpu, Layers, Zap, GitBranch, Palette } from "lucide-react";
        ...
        {tools.map((tool, idx) => {
          ...
          return (
            <motion.div
              ...
              className={`group relative p-8 rounded-2xl bg-[#0A0A0F]/80 border border-slate-800/80 backdrop-blur-xl transition-all duration-300 ${tool.borderColor} ${tool.glowColor}`}
            >
